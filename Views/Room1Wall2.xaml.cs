...
public partial class Room1Wall2 : ContentPage
{
	...
	protected override async void OnAppearing()
	{
		...
		// 检查当前房间的画碎片是否已被收集
		var shelfPictureFragment = await App.InventoryRepo.GetInventoryItemAsync("shelf_picture_fragment");
		if (shelfPictureFragment != null && shelfPictureFragment.IsCollected)
		{
		...
		{
			ShelfPictureFragment.IsVisible = true;
		}
	...
	private async void OnShelfPictureFragmentClicked(object sender, EventArgs e)
	{
	...
	public async void OnShelfBookClicked(object sender, EventArgs e)
	{
		await this.FadeTo(0, 500);
